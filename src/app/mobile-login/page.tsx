...
const COPY = {
  ...
  ar: {
    ...
    missingToken: "رابط الدخول غير صالح أو ناقص.",
    blockedIp:
      "تعذر الدخول. بان استعمال غير عادي، وتم توقيف المحاولة لحماية الحساب. تواصل مع الدعم.",
    geoRequired:
      "تعذر الدخول. خاص تفعّل الولوج للموقع الجغرافي فهاد الحساب.",
    geoUnavailable: "الموقع الجغرافي ما متوفرش فهاد الجهاز أو المتصفح.",
    failed: "وقع مشكل فالدخول. عاود المحاولة.",
    connected: "تم تسجيل الدخول. جاري التحويل…",
