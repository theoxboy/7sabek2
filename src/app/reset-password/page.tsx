...
> = {
  ...
  ar: {
    ...
    invalidMissingToken: "الرابط غير صالح: التوكن ناقص.",
    invalidToken: "الرابط غير صالح ولا منتهي. طلب رابط جديد.",
    ...
    invalidLinkBlockPrefix: "رابط إعادة التعيين غير صالح. رجع لصفحة",
    ...
    superadminVerificationFailed: "فشل تحقق superadmin.",
    tokenExpired: "الرابط غير صالح ولا منتهي. طلب رابط جديد.",
