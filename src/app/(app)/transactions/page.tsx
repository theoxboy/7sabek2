...
const TRANSACTIONS_COPY = {
  ...
  ar: {
    title: "العمليات",
    subtitle: "منين كتسجل دخل كيزيد فالكاش. ومنين كتسجل مصروف كينقص غير من الظرف المرتابط.",
    ...
    mapped: "مربوط",
    search: "البحث",
    searchPlaceholder: "قلب بالوصف ولا بالفئة",
    ...
    categoryNotMapped:
      "هاد الفئة ما مربوطة حتى بظرف. ربطها بظرف قبل ما تزيد هاد المصروف.",
