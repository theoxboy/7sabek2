...
const DASHBOARD_COPY: Record<FloussyLocale, DashboardCopy> = {
  ...
  ar: {
    ...
    sweepDoneTitle: "تم تنفيذ السويب",
    sweepDoneDescription: "تحدّثات الأرصدة.",
    sweepErrorTitle: "ما قدرناش نديرو السويب",
    ...
    tourAvailableTitle: "لكاش المتوفر",
    ...
    tourRecentTitle: "آخر المصاريف",
    tourRecentDescription: "راجع آخر المصاريف باش تصلّح أي حاجة بسرعة.",
    tourSpendingTitle: "تفصيل الصرف حسب الظرف",
    ...
    navDashboard: "اللائحة الجانبية — لوحة القيادة",
    navDashboardDesc: "ترجع للوحة القيادة فاي وقت.",
    ...
    navDistributionDesc: "وزّع لكاش المتوفر على الأظرفة.",
    ...
    mapNow: "ربط الفئات دابا",
    overspentAlert: (count: number, names: string) =>
      `🔴 عندك ${count} أظرفة خارجين على الحد (${names}${count > 3 ? "..." : ""})`,
    overspentDesc: "واحد ولا أكثر من الأظرفة نزل تحت الصفر فهاد الفترة.",
    overspentHelp: "دخل للأظرفة المعنيين، ومن بعد صحح الميزانية، ولا زيد المصروف الناقص، ولا وزّع عليهم من لكاش.",
    seeAll: "شوف كاملين",
    sweepReady: "✅ السويب واجد",
    sweepReadyDesc: "دابا تقدر تسالي هاد الفترة ويتدار التعامل مع الأرصدة المعنية.",
    sweepExecute: "نفّذ السويب",
    executing: "كيتنفذ...",
    sweepNotDue: "🟡 السويب: مازال ما وصلش الوقت ديالو",
    sweepNotDueDesc: "دابا ما كاين حتى إجراء خاص بالسويب.",
    sweepHelp: "السويب ما كيتدارش حتى كتوصل نهاية الفترة وكيكون الدخل المتوقع تصرّح به.",
